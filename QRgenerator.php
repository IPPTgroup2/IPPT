...
$activePage = isset($_GET['page']) ? $_GET['page'] : 'qrgenerator';
...
<head>
  ...
  <link rel="stylesheet" href="styles/adminqr.css">
</head>
...
<body  class="<?php echo $activePage; ?>">
    <nav class="main-nav">
        ...
        <ul class="main-nav-ul">
            ...
            <li><a href="QRgenerator.php" class="<?php echo isCurrentPage('qrgenerator') ? 'active' : ''; ?>"><i class='fas fa-cogs' style="font-size: 20px; color:#105e4e;"></i> Generate QR Code</a></li>
            ...
            <li class="has-submenu">
                <a href="#" class="<?php echo isCurrentPage('servicerequest') || isCurrentPage('servicerequeststatus') || isCurrentPage('servicerequesthistory') ? 'active' : ''; ?>"><i class='far fa-calendar-alt' style="font-size: 20px; color:#76ffa2;"></i> Service Request</a>
                <ul class="submenu" id="sr-submenu">
                    <li><a href="adminSRstatus.php" class="<?php echo isCurrentPage('servicerequeststatus') ? 'active' : ''; ?>"><i class="far fa-calendar-check" style="font-size: 20px; color:#76ffa2;"></i> Status</a></li>
                    <li><a href="adminSRhistory.php" class="<?php echo isCurrentPage('servicerequesthistory') ? 'active' : ''; ?>"><i class="fas fa-history" style="font-size: 20px; color:#76ffa2;"></i> Request History</a></li>
                </ul>
            </li>
            <li class="has-submenu">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($filename)) {
      echo '<script>alert("Please enter a filename.");</script>';
  } else {

      // Predefined PHP file path
      $php_file_path = "http://localhost:3000/personnelattendance.php";
      // Generate the QR code with the URL of the personnelattedance.php file
      $qrData = $php_file_path;
      $qrCode = 'https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=' . urlencode($qrData);
      ...
      // Display the QR code and open the personnelattendance.php file when scanned
      echo '
      <div class="qr-container">
          <img class="qr" src="' . $imagePath . '" alt="QR Code">
      </div>
      <div class="message">
          <p>QR code generated successfully! Image saved as ' . $imagePath . '</p>
      </div>';
...
?>
          <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
              ...
              <br><br>
              <div class="generate">
                <input style = "font-size: 18px;" type="submit" value="Generate QR Code">
              </div>
          </form>
