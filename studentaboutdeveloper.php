        ...
        <ul class="main-nav-ul">
            ...
            <li class="has-submenu">
                ...
                <ul class="submenu" id="sr-submenu">
                    ...
                    <li><a href="studentaboutdeveloper.php" class="<?php echo isCurrentPage('aboutdeveloper') ? 'active' : ''; ?>"><i class="fas fa-question-circle" style="font-size: 20px; color:#105e4e;"></i> About Developer</a></li>
                </ul>
            </li>
