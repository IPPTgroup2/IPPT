    ...
    <nav class="main-nav">
        ...
        <ul class="main-nav-ul">
            ...
            <li class="has-submenu">
                ...
                <ul class="submenu" id="sr-submenu">
                    <li><a href="studentaboutsystem.php" class="<?php echo isCurrentPage('aboutsystem') ? 'active' : ''; ?>"><i class="fas fa-question-circle" style="font-size: 20px; color:#105e4e;"></i> About System</a></li>
