...
<body  class="<?php echo $activePage; ?>">
  ...
  <?php
   ...
   $attendanceSql = "SELECT name,office, status FROM attendance2 WHERE name OR office LIKE '%$searchName%'";
  ...
  <?php
      if ($attendanceResult->num_rows > 0) {
        ...
        $color = '<span style="color:red; font-size: 30px;">&#9679;</span>'; // Red circle for Time Out
          ...
          echo "<p><a href=\"studentpersonnelinfo.php?name=" . urlencode($name) . "\">$name ($office) $color</a></p>";
    }
  } else {
